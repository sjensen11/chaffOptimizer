classdef thePlateDELETE
    ...
    methods
        ...
        function obj = thePlateDELETE(NumCells, len ,phiInc,thetaInc)
            ...
            for nn = 0:NumEdges-1
                Byn_xx(1+nn*NumCells:NumEdges+nn*NumCells+1) =  del/2:del:len-del/2;
        ...
        function obj = generateMatrix(obj)
            ...
            TxmBxn = zeros(numElt);
            TxmBxnsp = zeros(numElt);

            TxmByn = zeros(numElt);
            
            TymByn = zeros(numElt);
            TymBynsp = zeros(numElt);
            ...
            parfor mm = 1:numElt 
                ...
                for nn = 1:numElt 
                    ...
                    xmxn = obj.Bxn_xx(mm)-obj.Bxn_xx(nn);
                    ymyn = obj.Bxn_yy(mm)-obj.Bxn_yy(nn);
                    ...
                    TxmBxn(mm,nn) = integral2(gg,   del/2-xmxn,    del*3/2-xmxn, -del/2+ymyn, del/2+ymyn)...
                    ...
                    TxmBxnsp(mm,nn) = integral2(ggpp1xx,xmxn-del*3/2,xmxn-del/2,  ymyn-del/2,ymyn+del/2)...
                    ...
                    %---------------fourth convolution------------
                    xmxn= obj.Byn_xx(mm)-obj.Byn_xx(nn);
                    ymyn= obj.Byn_yy(mm)-obj.Byn_yy(nn);
                    %first integral
                    TymByn(mm,nn) =    integral2(gg,xmxn-del/2,xmxn+del/2,ymyn-del*3/2,ymyn-del/2)...
                    ...
                    TymBynsp(mm,nn) =    integral2(ggpp1yy,xmxn-del/2,xmxn+del/2,ymyn-del*3/2,ymyn-del/2)...
